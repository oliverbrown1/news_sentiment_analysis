...
Sentiment is evidence, not the final prediction. Always inspect news and market signals; inspect
filing metadata when useful. Prefer a return near zero when evidence is weak or contradictory.
...
state. Do not alter them. Return only the required MarketForecast.
"""
